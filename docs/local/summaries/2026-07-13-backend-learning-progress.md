...
21. Completed the Redis cache breakdown lesson review. User correctly explained hot key expiration causing concurrent DB回源, mutex rebuild with Redis lock and requestId-safe release, bounded waiting for lock losers, logical expiration tradeoffs, hot key update strategy avoiding direct delete, scenario choice for logic-expire + active refresh, lock TTL tradeoffs, distinguishing breakdown/penetration/avalanche, and cross-layer metrics for diagnosis. Updated the original cache-breakdown article with hot-key update guidance.
22. Completed the cache penetration lesson review. User correctly explained nonexistent data bypassing Redis to DB, null marker cache and short TTL, random ID scans making null markers insufficient, Bloom Filter maybe/definitely-not semantics, Bloom false positives, create/delete maintenance, recent-created bypass for async Bloom updates, null-marker pollution controls, and layered defenses from gateway/API to Bloom/Redis/DB. Updated the original cache-penetration article with Bloom sizing, recent-created bypass, and null marker pollution guidance.

## Technical Context
- Files modified: `docs/study-progress.md`, `sidebars.js`, `docs/local/summaries/2026-07-13-backend-learning-progress.md`, `docs/study/lessons/01-request-lifecycle.md`, `docs/study/lessons/02-http-timeout-retry.md`, `docs/study/lessons/03-connection-pool.md`, `docs/study/lessons/04-index-and-slow-query.md`, `docs/study/lessons/05-transaction-isolation.md`, `docs/study/lessons/06-database-locks.md`, `docs/study/lessons/07-pagination.md`, `docs/study/lessons/08-cache-aside.md`, `docs/study/lessons/09-cache-breakdown.md`, `docs/study/lessons/10-cache-penetration.md`, `docs/cache/cache-aside.md`, `docs/cache/cache-breakdown.md`, `docs/cache/cache-penetration.md`, `docs/fundamentals/request-lifecycle.md`, `docs/fundamentals/http-timeout-retry.md`, `docs/fundamentals/connection-pool.md`, `docs/database/index-and-slow-query.md`, `docs/database/transaction-isolation.md`, `docs/database/database-locks.md`, `docs/database/pagination.md`
...
## Open Questions
- Continue to `docs/cache/cache-avalanche.md` next to learn cache avalanche, mass expiration, Redis outage protection, and database fallback controls.
